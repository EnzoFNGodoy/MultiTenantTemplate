...
namespace MultTenantTemplate.WebApi.Configurations.Swagger;
...
public class EnableQueryFilter : IOperationFilter
{
        ...
        new List<(string Name, string Description)>()
    {
        ...
        ( "$count", "Exibe o campo que informa a quantidade de registros existentes."),
        ( "$expand", "Acessa um objeto relacionado.")
